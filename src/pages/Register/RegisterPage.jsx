                            ...
                            <div className="card-body p-4 p-md-5">
                                ...
                                <form onSubmit={handleSubmit} className='center'>
                                    ...
                                    <div className="form-outline mb-4">
                                        ...
                                        />
                                        <label className="form-label" htmlFor="birth_date">Birthday</label>
                                    </div>
                                    ...
                                    <div className="form-outline mb-4">
                                        ...
                                        <label className="form-label" htmlFor="form6Example5">Confirm Password</label>
                                    </div>
                                    ...
                                    <div className="row mb-4">
                                        <div className="col">
                                            ...
                                            <div className="form-outline mb-2">
                                                <input type="tel" id="phone_prefix" className="form-control"
                                                    pattern="[+0-9]{3}"
                                                    onChange={e => { setPhonePrefix(e.target.value) }}
                                                />
                                                <label className="form-label" htmlFor="phone_prefix">Phone prefix <span> (format : +33)</span></label>
                                            </div>
                                        </div>
                                        {/* <!-- phone number input --> */}
                                        <div className="col">
                                            <div className="form-outline mb-2">
                                                ...
                                                />
                                                <label className="form-label" htmlFor="phone_number">Phone number <span> (format : 605438481)</span></label>
                                            </div>
                                        </div>
                                    </div>
